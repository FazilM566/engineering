...
К существующему CLI-приложению для EDA добавлен **HTTP-сервис на FastAPI** с эндпоинтами `/health`, `/quality`, `/quality-flags-from-csv`и `/quality-from-csv`.  
...
### 5. `POST /quality-flags-from-csv` – набор флагов качества по CSV-файлу
