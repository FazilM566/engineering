...
```
5. - **Вариант А (рекомендуемый):** скопируйте в ноутбук код функции prepare_dataset из src/data/prepare.py (или импортируйте её, добавив sys.path). Выполните её, указав пути к исходной и целевой папкам. Это даст такую же структуру train/val/test, как в локальных скриптах.
